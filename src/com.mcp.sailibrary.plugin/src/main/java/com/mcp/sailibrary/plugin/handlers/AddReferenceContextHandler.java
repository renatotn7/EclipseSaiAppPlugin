...
/** * Adiciona a selecao atual do editor ou explorer como contexto referencial. * * <p>Quando a acao for disparada no editor com selecao textual, o handler deve * acionar o fluxo textual. Quando a acao vier do explorer, o handler deve * acionar o fluxo estrutural.</p> * * @author Renato Tomaz Nati * @since 2026-05-20 */
public class AddReferenceContextHandler extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        try {
            ...
            if (chatView != null) {
                ...
                if (chatView.getNamedBlocksPanel() != null
                    ...
                    if (selectionAtual instanceof ITextSelection) {
                        chatView.getNamedBlocksPanel().getController().adicionarSelecaoComoReferencia();
                    } else {
                        chatView.getNamedBlocksPanel().getController().adicionarComoReferencia(selectionAtual);
                    }
            ...
            throw new ExecutionException("Falha ao abrir ChatView para adicionar contexto referencial.", e);
        } catch (Exception e) {
            throw new ExecutionException("Falha ao resolver a selecao atual para contexto referencial.", e);
        }
