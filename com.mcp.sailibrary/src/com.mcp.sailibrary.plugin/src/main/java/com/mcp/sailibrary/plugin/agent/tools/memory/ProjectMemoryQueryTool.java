...
public class ProjectMemoryQueryTool implements AgentTool, AgentToolPromptMetadataProvider {
    ...
    /** * Inicializa a ferramenta de leitura da memoria persistente do projeto. * * @param rootDirectory raiz segura do projeto atual */
    ...
    /** * Le um ou mais arquivos da memoria persistente do projeto. * * @param jsonParameters parametros JSON da ferramenta * @return conteudo consultado ou resumo textual */
    @Override
    ...
    /** * Resolve a raiz efetiva do projeto para leitura da memoria persistente. * * @param jsonParameters parametros JSON da ferramenta * @return raiz efetiva do projeto */
    ...
    /** * Monta uma visao resumida da memoria persistente sem despejar tudo. * * @param memoryPaths caminhos da memoria persistente * @param jsonSupport gateway JSON da memoria * @return resumo textual */
